...
public class S5ProverTest {
    ...
    public Object[][] completenessTestsProvider() throws Reader.ParsingException {
        ...
        List<Problem > tests = ProblemReader.readFrom(TippaeSandbox.class.getResourceAsStream("S5-completness-tests.clj"));
    ...
    public Object[][] debugTestsProvider() throws Reader.ParsingException {
        ...
        List<Problem >tests = ProblemReader.readFrom(TippaeSandbox.class.getResourceAsStream("firstorder-debug-tests.clj"));
        Object[][] cases =  new Object[tests.size()][2];
    ...
    public Object[][] soundnessTestsProvider() throws Reader.ParsingException {
        ...
        List<Problem >tests = ProblemReader.readFrom(TippaeSandbox.class.getResourceAsStream("S5-soundness-tests.clj"));
        Object[][] cases =  new Object[tests.size()][2];
