...
public class CCProverTests {
    ...
    public Object[][] completenessTestsProvider() throws Reader.ParsingException {
       ...
       List<Problem >tests = ProblemReader.readFrom(CCProverTests.class.getResourceAsStream("cognitivecalculus-completeness-tests.clj"));
    ...
    public Object[][] debugTestsProvider() throws Reader.ParsingException {
        ...
        List<Problem >tests = ProblemReader.readFrom(CCProverTests.class.getResourceAsStream("sandbox.clj"));
        Object[][] cases =  new Object[tests.size()][2];
